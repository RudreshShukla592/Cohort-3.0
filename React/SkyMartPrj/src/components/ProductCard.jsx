...
const ProductCard = ({ product }) => {
  ...
  return (
    <div className="group overflow-hidden rounded-2xl border border-zinc-800 bg-[#151515] transition-all duration-300 hover:-translate-y-1 hover:border-lime-400 hover:shadow-[0_0_25px_rgba(163,230,53,0.08)]">
      ...
      <div onClick={()=> navigate(`/detail/${product.id}`)} className="relative flex h-64 items-center justify-center overflow-hidden bg-white p-6">
      ...
      <div className="space-y-3 p-5">
        ...
        <div className="flex items-center justify-between pt-2">
          ...
          <button className="flex items-center gap-2 rounded-xl bg-lime-400 px-4 py-2 text-sm font-semibold text-black transition-all duration-300 hover:scale-105 active:scale-95">
